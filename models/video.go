...
func (v *VideoDAO) QueryVideoByVideoId(videoId int64, video *Video) error { //查视频通过视频id
	if video == nil {
...
func (v *VideoDAO) QueryVideoCountByUserId(userId int64, count *int64) error { //查视频通过 用户id
	if count == nil {
...
func (v *VideoDAO) QueryVideoListByUserId(userId int64, videoList *[]*Video) error { //用户的全部视频
	if videoList == nil {
